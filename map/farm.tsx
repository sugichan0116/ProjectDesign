...
<tileset version="1.2" tiledversion="1.2.1" name="farm" tilewidth="64" tileheight="64" tilecount="20" columns="4">
 <image source="../dot/export/map/farm.png" width="256" height="320"/>
 <terraintypes>
  <terrain name="farm" tile="0"/>
 </terraintypes>
