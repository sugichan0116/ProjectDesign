...
<tileset version="1.2" tiledversion="1.2.1" name="UI" tilewidth="384" tileheight="128" tilecount="9" columns="0">
 ...
 <tile id="1">
  <image width="64" height="64" source="../dot/export/system/item-slot.png"/>
 </tile>
 <tile id="2">
  <image width="64" height="64" source="../dot/export/system/item-slot-sample.png"/>
 </tile>
 <tile id="3">
  <image width="64" height="64" source="../dot/export/system/ui-shading.png"/>
 </tile>
 <tile id="4">
  <image width="384" height="64" source="../dot/export/system/menu-icons.png"/>
 </tile>
 <tile id="5">
